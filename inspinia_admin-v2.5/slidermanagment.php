          ...
          ?>
            ...
            <div class="container-fluid" style="margin-top: 20px">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 style="color: red; text-align: center">Enter Slider Contents</h2>
...
<?php
 if(isset($_POST['submit'])){
     ...
     $fn="../img/home/banner-slider/".$fname;
     $f="img/home/banner-slider/".$fname;
     move_uploaded_file($ftemp, $fn);
     $con=mysqli_connect("localhost","root","","summer");
     $sql="insert into slider (name,price,pdesc,image) values('$name',$price,'$pdesc','$f')";
